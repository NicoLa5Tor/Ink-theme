...
$ink_home_data = array(
	'hero'      => array(
		...
		'heroImage'    => ink_img_url( 21, '/assets/hero/mas-clientes.webp' ),
		'heroImageB'   => ink_img_url( 22, '/assets/hero/mas-ventas.webp' ),
		'stats'        => array(
			array(
				'value' => 180,
	...
	'services'  => array(
		...
		'services' => array(
			array(
				...
				'href'        => '#contacto',
				'icon'        => '🎯',
				'image'       => ink_img_url( 25, '/assets/services/estrategia.webp' ),
			),
			array(
				...
				'href'        => '#contacto',
				'icon'        => '📱',
				'image'       => ink_img_url( 28, '/assets/services/redes.webp' ),
				'frame'       => 'portrait',
			),
			array(
				'title'       => 'Meta Ads',
				...
				'href'        => '#contacto',
				'icon'        => '📈',
				'image'       => ink_img_url( 27, '/assets/services/meta-ads.webp' ),
			),
			array(
				'title'       => 'Google Ads',
				...
				'href'        => '#contacto',
				'icon'        => '🔍',
				'image'       => ink_img_url( 26, '/assets/services/google-ads.webp' ),
			),
			array(
				'title'       => 'SEO',
				...
				'href'        => '#contacto',
				'icon'        => '🚀',
				'image'       => ink_img_url( 29, '/assets/services/seo.webp' ),
			),
			array(
				...
				'href'        => '#contacto',
				'icon'        => '✉️',
				'image'       => ink_img_url( 24, '/assets/services/email.webp' ),
			),
			array(
				...
				'icon'        => '🤖',
				'badge'       => 'nuevo',
				'image'       => ink_img_url( 23, '/assets/services/chatbots.webp' ),
				'frame'       => 'portrait',
			),
			array(
				...
				'href'        => '#contacto',
				'icon'        => '💻',
				'image'       => ink_img_url( 30, '/assets/services/web.webp' ),
			),
		),
	),
	'results'   => array(
